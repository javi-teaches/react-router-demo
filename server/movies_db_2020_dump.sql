...
--
-- Host: localhost    Database: movies_db_2020
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS `movies_db_2020`;
USE `movies_db_2020`;
...
-- Dump completed on 2020-08-04 22:48:22
